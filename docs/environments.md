...
<div class="environment-grid">
  ...
  <div class="environment-card">
    ...
    <div class="environment-card__links">
      ...
      <a class="environment-card__icon environment-card__icon--hf" href="https://huggingface.co/spaces/sergiopaniego/repl" target="_blank" rel="noreferrer noopener" aria-label="REPL on Hugging Face">
        <img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" alt="" aria-hidden="true" />
      </a>
    </div>
  </div>
