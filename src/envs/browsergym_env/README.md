...
If you use BrowserGym in your research, please cite:

```bibtex
@article{drouin2024browsergym,
  title={BrowserGym: A Gymnasium Environment for Web Task Automation},
  author={Drouin, Alexandre and others},
  journal={arXiv preprint arXiv:2407.xxxxx},
  year={2024}
}

@article{liu2023miniwob,
  title={MiniWoB++: A Web Interaction Benchmark for Reinforcement Learning},
  author={Liu, Evan Zheran and others},
...
BrowserGym is licensed under the MIT License. WebArena is licensed under Apache 2.0. See respective project repositories for details.
